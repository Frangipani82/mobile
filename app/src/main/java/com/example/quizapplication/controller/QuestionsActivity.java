...
public class QuestionsActivity extends AppCompatActivity {
    ...
    private QuestionsList thisList = new QuestionsList();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.tvLevelText.setText(level);

        //Get the question list depends on the level
        questionList = thisList.getQuestionsList(level);

        //ArrayList for the user answers
        userAnswers = new ArrayList<>();

        //Getting first question
        firstQuestion = questionList.get(0);
            ...
            public void onClick(View view) {
                ...
                //At the last question go to next activity
                    ...
                    if(currentQuestionIndex == questionList.size() - 1) {
                        ...
                        //Next line comes from https://claude.ai
                        return;
                    }
    ...
    //Implementation of clearRadioButtons method from https://www.phind.com
   ...
   /* Populating the userAnswers arrayList with the texts of the buttons
    ...
    public ArrayList<String> addUserAnswer() {
        ...
        //Getting user answers from checkboxes
        } else {
            if(binding.chkAnswer1.isChecked()) {
    ...
    //Implemented from https://chatgpt.com
    ...
    public void answerCorrect() {
        ...
        //Next line is from https://chatgpt.com
       if(!isAnyAnswerSelected(currentQuestion)) {
        ...
        //If answer is correct increase the correctAnswers
        if(currentQuestion.isAnswerCorrect(userAnswers, currentQuestion.getCorrectAnswers())) {
            correctAnswers++;

        //Else add current question to wrong question list
        } else{
            wrongList.add(currentQuestion);
        }
    }

    //After the last question takes the user to the FinalActivity
    ...
    public void showQuestionNumber() {
      binding.tvQuestionNumber.setText(String.valueOf(currentQuestionIndex + 1) + "/" + questionList.size());
    }
}
